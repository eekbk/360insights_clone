...
export default function Navbar() {
  ...
  return (
    <nav className="top-0 sticky bg-white z-[100] flex flex-col lg:flex-row justify-center">
      ...
      {isHamburgerOpen &&
        <div className="bg-white shadow-sm w-full flex flex-col px-5 text-sm font-semibold lg:hidden overflow-y-auto overscroll-none top-14">
