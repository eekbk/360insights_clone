...
export default function Navbar() {
  ...
  return (
    <nav className="top-0 sticky bg-white z-[100] overscroll-none">
      <div className="w-full flex justify-between px-5 py-2">
        ...
        {isHamburgerOpen &&
          <div className="bg-white w-full flex flex-col px-5 text-sm font-semibold lg:hidden overscroll-none overflow-y-auto">
            ...
            {isProductsOpen && <MobileMenuModal section={products} />}
            <div className={mobileMenuClasses} onClick={() => {setIsSolutionsOpen(!isSolutionsOpen)}}>
              ...
              {isSolutionsOpen && <MobileMenuModal section={solutions} />}
